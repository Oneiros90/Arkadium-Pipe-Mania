...
describe('FlowSystem', () => {
    ...
    it('should transition to Flowing when started', () => {
        const startCell = new Cell({ row: 0, col: 0 });
        mockValidator.getStartCell.mockReturnValue(startCell);
        mockValidator.getNextCell.mockReturnValue({ cell: new Cell({ row: 0, col: 1 }), entryDirection: Direction.West });
    ...
    it('should advance to next cell when full', () => {
        ...
        mockValidator.getNextCell
            ...
            .mockReturnValueOnce({ cell: new Cell({ row: 0, col: 2 }), entryDirection: Direction.West }); // Second call for next
